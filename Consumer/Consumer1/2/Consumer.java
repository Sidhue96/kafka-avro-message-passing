...
public class Consumer{
    public static void main(String[] args) throws Exception{
        String topicName = "Male";                                            
        String groupName = "MaleGroup";
    ...
    private static void saveAndCommit(ConsumerRecord<String, Practice> record){
        ...
        try{
            ...
            String sql = "INSERT INTO male (id,pid,gender,age,hypertension,heart_disease,ever_married,work_type,residence_type,avg_glucose_level,bmi,smoking_status,stroke,time_stamp) "
